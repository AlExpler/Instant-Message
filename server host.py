...
def handle_client(client):
    ...
    while True:
        ...
        if msg.startswith("{REGISTER}"):
            ...
            msg = "{MSG}%s connected to the chat!" % name
        ...
        if msg == "{QUIT}":
            ...
            try:
                ...
                pass
            if name:
                send_message("{MSG}%s left chat." % name, broadcast=True)
                send_clients()
            break
        ...
        try:
            ...
            if dest_sock:
                ...
                print("Wrong address. %s" % dest_name)
        except:
            print("Can't read message: %s" % msg)
...
if __name__ == "__main__":
    try:
        SERVER.listen(5)
        print("Server starts in {}:{}".format(HOST, PORT))
